			...
			<div class="col-xs-12 col-sm-9 content">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><b>신청 대상정보</b></h3>
							</div>
							<div class="panel-body">
								<div class="row">
								...
								<div class="row form-inline">
									...
									<div class="col-md-10">
										...
										<input type="button" class="btn btn-info btn-xs" value="팝업창">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="panel-title"><b>신청 정보</b>
								</div>
							...
							<div class="panel-body">
										...
										<div id="talWantField" class="form-group">
											...
											<div id="talWantSelect_0" class="form-inline col-md-10">
												<div class="form-inline">
													...
													<select id="talWantDiv_0" name="talWantDiv_0" class="form-control"
													        onclick="selDiv(this);">
														<option class="divDefult" value="none"></option>
													</select>
													<input type="button" class="btn btn-info btn-sm" id="talWantAdd"
													       value="추가">
										...
										<div id="talHaveField" class="form-group">
											...
											<div id="talHaveSelect_0" class="form-inline col-md-10">
												<div class="form-inline">
													...
													<select id="talHaveDiv_0" name="talHaveDiv_0" class="form-control"
													        onclick="selDiv(this);">
														<option class="divDefult" value="none"></option>
													</select>
													<input type="button" class="btn btn-info btn-sm" id="talHaveAdd"
													       value="추가">
													<input type="button" class="btn btn-info btn-sm remove"
								...
								<div class="form-group">
									<div class="col-md-offset-2 col-md-10">
										<input class="btn btn-info" type="button" value="전송"/>
										<input class="btn btn-info" type="button" value="취소"/>
									</div>
								</div>
								</form>
								<%-- CONTENT 끝--%>
