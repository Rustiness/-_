	...
	$(document).ready(
		function() {
			...
			if (loginMem == memNO) {
				...
				$("#deleteBtn").html("<input type='button' value='교환글 삭제' class='btn btn-danger'>");
						...
						<table border="0">
							...
							<tr>
								<td colspan="4"><input type="button" value="목록"
									id="goListBtn" class="btn btn-info"> <span
									id="deleteBtn"></span> <input type="button" value="교환 알림함"
									class="btn"> <span style="float: right"> 작성일자: <fmt:formatDate
											pattern="yyyy-MM-dd HH:mm:ss"
											value="${TalBoardVO.writeDate }" />
								</span></td>
							</tr>
						</table>
					</div>
