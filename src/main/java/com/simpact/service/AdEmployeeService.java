...
public interface AdEmployeeService {
	public int modify(EmployeeVO vo)throws Exception;  //수정
	...
	public List<GradeDFVO> readgrade(String memNO)throws Exception;	//상세보기직원 관리등급리스트
	public List<PositionDFVO> readposition(String memNO)throws Exception;	//상세보기직원 직챙정보리스트
